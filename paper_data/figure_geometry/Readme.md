...
transfer inside the slab it emerges at viewing angle θ_view. The emergent
(outward) direction is taken as positive.

## Files
- `incidence_geometry.py` — draws the schematic.
