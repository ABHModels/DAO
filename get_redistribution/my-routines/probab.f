      subroutine probab(bk2_value,temper,enprim,encent,mgi,smit,agt,
     & total)
c........ 
...
c.......  nr=1 : exact by Suleimanov et al. (2012), Madej et al. (2017)
c.......
      double precision function profil(nr,eps,eps1,costh,x,bk2_value)
      implicit none
...
c.......  function being scaled by exp(x). See bk2.f for the details.
   16 continue
      ...
      profil=3.d0/32.d0/pi/bk2_value*integ     *eps1/eps
c.......
      return
      end
c.......
