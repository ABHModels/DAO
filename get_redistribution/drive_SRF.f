...
c........    
      ...
      parameter (nmaxp=1000, itrans=70, mgi=3000)
...
c     Get current time
      call cpu_time(tini)
      open(unit=9999,file='log',status='unknown')
      flush(9999)
c
...
c     1 : exactly  kernel type
c     2 : gaussian kernel type  
...
c
     ...
     1     mgi, smit, agt)
      ...
      case (22)
      call gaussiankernel(itrans,theta,nmaxp,wp,df,skn)
...
c
      write(9999,*) ' '
      write(9999,*) 'CPU time (s) =',real(tcpu)
      flush(9999)
c
